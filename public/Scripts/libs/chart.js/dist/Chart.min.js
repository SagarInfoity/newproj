    ...
    return function t(e, n, i) {
        ...
        57: [function(t, e, n) {
            ...
            function f(t, e, n, i, a, o) {
                ...
                r = v(f),
                c && i && !u && !l.round && (r.startOf(i),
                r.add(~~((f - r) / (h.size * s)) * s, n)); r < g; r.add(s, n))
                    p.push(+r);
                return p.push(+r),
                p
            }
                ...
                var e = {
                  ...
                  , n = t.Scale.extend({
                    ...
                    buildTicks: function() {
                        ...
                        for ("ticks" === l.bounds && x.length && (a = x[0],
                        r = x[x.length - 1]),
                        a = u(s.min, i) || a,
                        r = u(s.max, i) || r,
                        t = 0,
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        return b.isObject(r) && (o = n.getRightValue(r)),
