...
export const AddInternshipDetails = () => {
    ...
    const savedvv = () => {
        ...
        if(!inp1 || !inp2 || !inp3 || !inp4 || !inp5_1 || !inp6_1 || !inp7_1 || !inp8 || !inp9 || !inp10_1 || !inp11_1 || !inp12) {
                                    ...
                                    <form>
                                        <div className="cmpy-prfl-mdl2-dv1 cmpy-prfl-a6 pt-3 pb-3">
                                            <div className="form-group row m-0 col-sm-12 pt-3 pb-3">
                                                <label htmlFor="inputEmail3" className="col-sm-5 pl-0 col-xs-5 col-form-label tekila3">Internship Title</label>
                                                <div className="col-sm-7 col-xs-7 pl-0 row m-0 pr-0">
                                                    <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                                        <div className="col-sm-12 pl-0 pr-0 mb-2">
                                                            <input type="text" className="tekila6" id="mdlinpfld41" placeholder="Enter internship name" autocomplete="off" maxlength="30" />
                                            ...
                                            <div className="form-group row m-0 col-sm-12 pt-3 pb-3">
                                                <label htmlFor="inputEmail3" className="col-sm-5 pl-0 col-xs-5 col-form-label tekila3"> Internship Type </label>
                                                <div className="col-sm-7 col-xs-7 pl-0 row m-0 pr-0">
                                                    <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                                        <div className="col-sm-12 pl-0 pr-0 mb-2">
                                            ...
                                            <div className="form-group row m-0 col-sm-12 pt-3 pb-3">
                                                <label htmlFor="inputEmail3" className="col-sm-5 pl-0 col-xs-5 col-form-label tekila3"> Internship Start Date </label>
                                                <div className="col-sm-7 col-xs-7 pl-0 row m-0 pr-0">
                                                    <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                                        <div className="col-sm-12 pl-0 pr-0 mb-2">
                                                            <input type="date" className="tekila6" id="mdlinpfld49" autocomplete="off" />
                                                            <div className="flderrmsgdv" id="mdlinpflderr49">Please select value</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="form-group row m-0 col-sm-12 pt-3 pb-3">
                                                <label htmlFor="inputEmail3" className="col-sm-5 pl-0 col-xs-5 col-form-label tekila3"> Internship Duration </label>
                                                <div className="col-sm-7 col-xs-7 pl-0 row m-0 pr-0">
                                                    <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                                        <div className="col-sm-7 pl-0 mb-2">
                                                            <Select id="mdlinpfld410" options={jbprfldurationdt} value={jbprfldurationdt.find(obj => obj.value === selectedjbprfldurationdt)} onChange={handleChange5} />
                                                            <div className="flderrmsgdv" id="mdlinpflderr410">Please select value</div>
                                                        </div>
                                                        {selectedjbprfldurationdt && <div style={{ display: 'none' }}>
                                                            <div id="slctcdjbprfldurationdt">{selectedjbprfldurationdt}</div>
                                                        </div>}
                                                        <div className="col-sm-5 pl-0 pr-0 mb-2">
                                                            <Select id="mdlinpfld411" options={jbprfldurationdtmn} value={jbprfldurationdtmn.find(obj => obj.value === selectedjbprfldurationdtmn)} onChange={handleChange6} />
                                            ...
                                            <div className="form-group row m-0 col-sm-12 pt-3 pb-3">
                                                <label htmlFor="inputEmail3" className="col-sm-5 pl-0 col-xs-5 col-form-label tekila3"> Intern's Responsibility </label>
                                                <div className="col-sm-7 col-xs-7 pl-0 row m-0 pr-0">
                                                    <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                                        <div className="col-sm-12 pl-0 pr-0 mb-2">
                                                            <textarea className="tekila6" id="mdlinpfld412" placeholder="Intern's day-to-day responsibilities" style={{height: '150px', resize: 'none'}}></textarea>
                                            ...
                                            <div className="form-group row m-0 col-sm-12 pt-3 pb-3">
                                                <label htmlFor="inputEmail3" className="col-sm-5 pl-0 col-xs-5 col-form-label tekila3"> Intern's (any specific preference base?) <br/> <span style={{fontSize: '12px', opacity: '0.5', fontFamily: 'Circular-Book'}}>(Optional)</span> </label>
                                                <div className="col-sm-7 col-xs-7 pl-0 row m-0 pr-0">
                                                    <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                                        <div className="col-sm-12 pl-0 pr-0 mb-2">
                                                            <input type="text" className="tekila6" id="mdlinpfld413" placeholder="Intern's preference base" autocomplete="off" maxlength="30" />
