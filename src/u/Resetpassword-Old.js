...
export const ResetpswordOld = () => {

    const handleSubmit = e => {
        e.preventDefault();
        var inpfld1 = $('#inpfld1').val();
        var inpfld2 = $('#inpfld2').val();
        var inpdlferr = $('#inpfld1err');

        if(inpfld1 === "" || inpfld1 === null || inpfld2 === "" || inpfld2 === null) {
                    ...
                    <div className="be-content">
                        <div className="main-content container-fluid disp-flex pb-0">
                            ...
                            <div className="card">
                                ...
                                <h2 className="u-bumperBottom--md Nwbs1"> Reset Password</h2>
                                <div className="card-body">
                                    <form id="form" name="form" action="" method="post" onSubmit={handleSubmit}>
                                    <div className="form-group">
                                        <input id="inpfld1" name="text" type="text" placeholder="New password" className="form-control" maxLength='30' autoFocus onKeyPress={(event)=>onKeyDown(event)} />
                                        <input id="inpfld2" name="text" type="text" placeholder="Confirm new password" className="form-control mt-3" maxLength='30' autoFocus  onKeyPress={(event)=>onKeyDown(event)} />
                                    ...
                                    <div className="form-group login-submit pt-0 mb-0">
                                        <button type="submit" className="btn btn-primary btn-xl nw-btn" id="signinbtn">Submit</button>
                                    </div>
                                    </form>
                                    <span className="splash-description"> <a href="/u/signin" className="Nwbs2"> Go back to Sign-in</a></span>
