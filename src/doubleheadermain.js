...
export const DoubleHeaderMain = () => {
    ...
    useEffect(() => {
        ...
        } else if (path === '/hiring/overview' || path === '/hiring/jobprofile' || path === '/hiring/candidates' || path === '/hiring/settings') {
          setPageTitle('Hiring');
        }
      }, [location.pathname]);
    ...
    return <div>
                ...
                <div className="content-header custom-blue box-shadow-4 cstm-hdrrr cstm-hdrrr2" id="content-header">
                    <div>
                        ...
                        <div className='dblhdr-cstmm-hdrsnd'>
                            <div>
                                <NavLink to='/hiring/overview' className={({ isActive }) => (isActive ? 'nvhdr active' : 'nvhdr inactive')}>
                                    <button className="dshbdhdrbtn">
                                        Overview
                                    </button>
                                </NavLink>
                                <NavLink to='/hiring/jobprofile' className={({ isActive }) => (isActive ? 'nvhdr active' : 'nvhdr inactive')}>
                                    <button className="dshbdhdrbtn">
                                        Job Profile
                                    </button>
                                </NavLink>
                                <NavLink to='/hiring/candidates' className={({ isActive }) => (isActive ? 'nvhdr active' : 'nvhdr inactive')}>
                                    <button className="dshbdhdrbtn">
                                        Candidates
                                    </button>
                                </NavLink>
                                <NavLink to='/hiring/settings' className={({ isActive }) => (isActive ? 'nvhdr ' : 'nvhdr inactive')}>
                                    <button className="dshbdhdrbtn">
                                        Settings
                                    </button>
                                </NavLink>
