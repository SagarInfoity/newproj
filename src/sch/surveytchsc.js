                ...
                <div className="row tab-content mb-3 mt-4">
                    ...
                    <div className="col-sm-12 row ml-0 mr-0 mb-4 p-0">
                        <div className="col-sm-3">
                            <Select options={slctdrpdwnoptions} defaultValue={{ label: "All Teachers", value: 0 }} value={slctdrpdwnoptions.find(obj => obj.value === selectedteacher)} />
                        </div>
                    ...
                    <div>
                        <div className="col-sm-12 bgclrblu">
                            <div className="dshbrd-dvv1 col-sm-12 row ml-0 mr-0">
                                <div className="col-sm-12">
                                    <div className="nwsrvdvdvd1">Survey Name - Teacher School Relationship- (Part 1) - Pulse 2</div>
                                                ...
                                                <table id="nwsrvytbblll" className="table brdr-none cstmtable2 v-middle p-0 m-0 box">
                                                    <thead>
                                                        <tr className="cstmsrtbthdbrdr">
                                                            <th className="pl-24px tblsccshdng">Teachers (10 / 20)</th>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div className="tbltddv1 txttrnsfrm-cpl text-truncate cstmwdtbldv crsr-pntr" onClick={()=>{handleShow();}}  title> 
                                                                    <img src="../Images/user_green.png" className="nwsrvdvdvdimg" />
                                                                    T Joshua Gonzalez 
                                                                </div>
                                                            </td>
                ...
                <div>
                    <div className="infomdvmdl1 col-sm-12 row m-0">
                        ...
                        <div className="col-sm-10">
                            ...
                            <div className="infomdvmdl3 row m-0">
                                ...
                                <div className="col-sm-6 text-truncate p-0" title>
                    ...
                    <div>
                        <div className="infomdvmdl3 col-sm-12 mt-4">
                            <h3 className="infomdvmdl3-h3"> Class </h3>
                            <div className="infomdvmdl3-txtara"> Subjects </div>
                        </div>                
                    </div>
                </div>
