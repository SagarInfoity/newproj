...
export const DoubleHeaderMainForJobProfile = () => {
                    ...
                    <div>
                                ...
                                <div className='mbvw-hdrrcs'>
                                    ...
                                    <div className='row m-0 cstmmthdrimgdv' alt="Back Button">
                                        ...
                                        <div className="row m-0">
                                            ...
                                            <div>
                                                <div className='hdrmnrytbrtxt'>Hiring</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className='dblhdr-cstmm-hdrsnd'>
                            <div>
                                ...
                                <NavLink to='/hiring/jobprofile' className={({ isActive }) => (isActive ? 'nvhdr active' : 'nvhdr active')}>
                                    <button className="dshbdhdrbtn">
                                        Job Profile
                                    </button>
                                </NavLink>
