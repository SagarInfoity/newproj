...
export const StudentAcademicDetails = () => {
    ...
    return <div>
                                ...
                                <div className="box-body" id="dtlsgnrlinfo-viwfld">
                                    <form>
                                        ...
                                        <div className="form-group row cmpy-prfl-rwdvhr ml-0 mr-0 cmpy-prfl-a6 pt-3 pb-4 cmp-prfl-mtcsfld">
                                            ...
                                            <div className="col-sm-8 col-xs-8 pl-0 row m-0" id="fielddv1">
                                                <div className="col-sm-9 col-xs-9 pl-0">
                                                    <label className="col-form-label tekila4">2020</label>
                                                </div>
                                                <div className="col-sm-3"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group row ml-0 mr-0 cmpy-prfl-a6 pt-3 pb-4 cmp-prfl-mtcsfld">
                                            ...
                                            <div className="col-sm-8 col-xs-8 pl-0">
                                                <label className="col-form-label tekila4">
                                                    Verified Successful
                                                    <i class="fa fa-check cmpy-prfl-admin-a8 ml-2"></i>
                                                </label>
                                            </div>
                                        </div>
                                        <div className="form-group row ml-0 mr-0 cmpy-prfl-a6 pt-3 pb-4 cmp-prfl-mtcsfld">
        ...
        <Modal show={show3} onHide={handleClose3} className="cmpy-prfl-mdl2" >
            <Modal.Header closeButton>
                <Modal.Title>12TH MARKSHEET DETAILS</Modal.Title>
            </Modal.Header>
            <Modal.Body className="cmpy-prfl-mdl-bdy-ht">
                <div className="cmpy-prfl-mdl2-dv1">
                    ...
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3">Board Name*</label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={BoardList} defaultValue={{value: 'CBSE', label: 'CBSE'}} className="crsr-pntr" value={BoardList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select option</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
                    ...
                    <div className="form-group row m-0 p-0">
                        ...
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={YearList} defaultValue={{value: '2022', label: '2022'}} className="crsr-pntr" value={YearList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select option</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
                    ...
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3"> Status </label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={TwlthScoreStatusList} defaultValue={{value: 'Verified Successful', label: 'Verified Successful'}} className="crsr-pntr" value={TwlthScoreStatusList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select field</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
                                </div>
                    ...
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3"> 12th Marks (%) </label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <input type="text" className="tekila6" id="mdlinpfld423" autocomplete="off" maxlength="30" defaultValue='80' />
                                    <div className="flderrmsgdv" id="mdlinpflderr423">Please enter data</div>
                                </div>
                            </div>
                        </div>
        ...
        <Modal show={show4} onHide={handleClose4} className="cmpy-prfl-mdl2" >
            ...
            <Modal.Footer>
                ...
                <Button variant="primary modalRedBtn" id="mdlbtn1" onClick={handleClose4}>
                    Update
                </Button>
            </Modal.Footer>
        </Modal>
        ...
        <Modal.Header closeButton>
                <Modal.Title>DEGREE MARKSHEET DETAILS</Modal.Title>
            </Modal.Header>
            <Modal.Body className="cmpy-prfl-mdl-bdy-ht">
                <div className="cmpy-prfl-mdl2-dv1">
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3">Univeristy State*</label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={StateList} defaultValue={{value: 'New Delhi', label: 'New Delhi'}} className="crsr-pntr" value={GenderList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                    ...
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3">Institution Name*</label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={InstitutionList} defaultValue={{value: 'XYZ College', label: 'XYZ College'}} className="crsr-pntr" value={InstitutionList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select option</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
                    ...
                    <div className="form-group row m-0 p-0">
                        ...
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={YearList} defaultValue={{value: '2024', label: '2024'}} className="crsr-pntr" value={YearList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select option</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
                    ...
                    <div className="form-group row m-0 p-0">
                        ...
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={DegreeScoreStatusList} defaultValue={{value: 'Verified Successful', label: 'Verified Successful'}} className="crsr-pntr" value={DegreeScoreStatusList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select field</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
                    ...
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3"> Degree Marks (%) </label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <input type="text" className="tekila6" id="mdlinpfld423" autocomplete="off" maxlength="30" defaultValue='80' />
                    ...
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3"> Prev Qualification </label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={PrevQualList} defaultValue={{value: 'NA', label: 'NA'}} className="crsr-pntr" value={PrevQualList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select field</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
            ...
            <Modal.Footer>
                ...
                <Button variant="primary modalRedBtn" id="mdlbtn1" onClick={handleClose5}>
                    Update
                </Button>
            </Modal.Footer>
        </Modal>
        ...
        <Modal show={show6} onHide={handleClose6} className="cmpy-prfl-mdl2" >
            ...
            <Modal.Footer>
                ...
                <Button variant="primary modalRedBtn" id="mdlbtn1" onClick={handleClose6}>
                    Update
                </Button>
            </Modal.Footer>
        </Modal>
        ...
        <Modal.Header closeButton>
                <Modal.Title>English Score Details</Modal.Title>
            </Modal.Header>
            <Modal.Body className="cmpy-prfl-mdl-bdy-ht">
                <div className="cmpy-prfl-mdl2-dv1">
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3">English*</label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <input type="text" className="tekila6" id="mdlinpfld421" placeholder="Enter data" autocomplete="off" maxlength="30" />
                                    <div className="flderrmsgdv" id="mdlinpflderr421">Please enter data</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="form-group row m-0 p-0">
                        ...
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={EnglishScoreStatusList} className="crsr-pntr" value={EnglishScoreStatusList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select field</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
                    ...
                    <div className="form-group row m-0 p-0">
                        <label htmlFor="inputEmail3" className="col-sm-4 pl-0 col-xs-4 col-form-label tekila3"> IELTS/ PTE/ TOEFL /Duolingo/ 12th English Score </label>
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <input type="text" className="tekila6" id="mdlinpfld423" autocomplete="off" maxlength="30" />
                                    <div className="flderrmsgdv" id="mdlinpflderr423">Please enter data</div>
                                </div>
                            </div>
                        </div>
            ...
            <Modal.Footer>
                ...
                <Button variant="primary modalRedBtn" id="mdlbtn1" onClick={handleClose7}>
                    Update
                </Button>
            </Modal.Footer>
        </Modal>
        ...
        <Modal show={show8} onHide={handleClose8} className="cmpy-prfl-mdl2" >
                ...
                <div className="cmpy-prfl-mdl2-dv1">
                    <div className="form-group row m-0 p-0">
                        ...
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <input type="text" className="tekila6" id="mdlinpfld421" placeholder="Enter data" autocomplete="off" maxlength="30" defaultValue="IELTS" />
                                    <div className="flderrmsgdv" id="mdlinpflderr421">Please enter data</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="form-group row m-0 p-0">
                        ...
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <Select options={EnglishScoreStatusList} defaultValue={{value: 'Verified Successful', label: 'Verified Successful'}} className="crsr-pntr" value={EnglishScoreStatusList.find(obj => obj.value === empDrpDwnValue)} onChange={handleChange1} />
                                    <div className="flderrmsgdv" id="mdlinpflderrdrpdwn">Please select field</div>
                                    {empDrpDwnValue && <div style={{ display: 'none' }}>
                                        <div id="mdlempdrpdwnvll">{empDrpDwnValue}</div>
                                    </div>}
                    ...
                    <div className="form-group row m-0 p-0">
                        ...
                        <div className="col-sm-8 col-xs-8 pl-0 row m-0 pr-0">
                            <div className="col-sm-12 col-xs-12 pr-0 pl-0 row m-0 cmpy-prfl-cspdd1">
                                <div className="col-sm-12 pl-0 pr-0 mb-2">
                                    <input type="text" className="tekila6" id="mdlinpfld423" autocomplete="off" maxlength="30" defaultValue='8' />
                                    <div className="flderrmsgdv" id="mdlinpflderr423">Please enter data</div>
                                </div>
                            </div>
                        </div>
            ...
            <Modal.Footer>
                ...
                <Button variant="primary modalRedBtn" id="mdlbtn1" onClick={handleClose8}>
                    Update
                </Button>
            </Modal.Footer>
        </Modal>
