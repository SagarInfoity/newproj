                        ...
                        <div className="tab" id="personalinfoddv1" style={{display: "block", paddingLeft: 2, paddingRight: 12}}>
                            <div className="col-md-12 mb-4">
                                <div className="tekila1">
                                    <div className="box-header cmp-prfl-brdr-btm">
                                        <div className="row m-0">
                                            <div className="col-sm-12 p-0 cspdlft-10">
                                    ...
                                    <div className="box-body" id="dtlsgnrlinfo-viwfld">
                                        <form>
                                            <div className="form-group row cmpy-prfl-rwdvhr ml-0 mr-0 cmpy-prfl-a6 pt-3 pb-4 pl-3">
                                                <label htmlFor="inputEmail3" className="col-sm-4 col-xs-4 col-form-label tekila3">Legal Name</label>
                                                <div className="col-sm-8 col-xs-8 pl-0 row m-0">
                                                    <div className="col-sm-9 col-xs-9 pl-0 row m-0">
                                                        <div className="col-sm-6 pl-0 pr-0 mb-2">
                                                            <input type="text" className="tekila6" id="cmpnyprflinpfld01" placeholder="First Name" autocomplete="off" maxlength="100" defaultValue="First Name" />
                                                            <div className="flderrmsgdv" id="cmpnyprflinpfld01-msg">Please enter first name</div>
                                                        </div>
                                                        <div className="col-sm-5 pl-0 pr-0 mb-2 ml-4">
                                                            <input type="text" className="tekila6" id="cmpnyprflinpfld01" placeholder="Last Name" autocomplete="off" maxlength="100" defaultValue="Last Name" />
                                            ...
                                            <div className="form-group row cmpy-prfl-rwdvhr ml-0 mr-0 cmpy-prfl-a6 pt-3 pb-4">
                                                ...
                                                <div className="col-sm-8 col-xs-8 pl-0 row m-0">
                                                    <div className="col-sm-5 col-xs-5 pl-0 pr-4">
                                                        <div className="col-sm-12 pl-0 pr-0 mb-2">
                                                            <input type="date" className="tekila6" id="cmpnyprflinpfld02" autocomplete="off" maxlength="100" defaultValue="2023-08-08" />
                                                            <div className="flderrmsgdv" id="cmpnyprflinpfld02-msg">Please select date</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="form-group row cmpy-prfl-rwdvhr ml-0 mr-0 cmpy-prfl-a6 pt-3 pb-4">
                                                ...
                                                <div className="col-sm-8 col-xs-8 pl-0 row m-0">
                                                    <div className="col-sm-5 col-xs-6 pl-0 pr-4">
                                            ...
                                            <div style={{borderTop: '1px solid #d8dce2'}}>
                                                <div className="col-sm-12 text-right mt-4 mb-4 pr-4">
                                                    {/* <Button variant="primary modalGrayBtn mr-3">
                                                        Cancel
                                                    </Button> */}
                                                    <Button variant="primary modalRedBtn mr-2">
                                                        Continue
                                                    </Button>
                                                </div>
                                            </div>
